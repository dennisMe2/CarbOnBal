...
const char txtContrastButton[]		PROGMEM = "Contrast Button";
...
const char txtDampingLess[]			PROGMEM = "Decrease Damping";
const char txtDampingPerc[] 		PROGMEM = "Damping: (%)";
const char txtDampingMore[]			PROGMEM = "Increase Damping";
